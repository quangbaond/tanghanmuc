...
<body>
    ...
    <style>
        ...
        @font-face {
            ...
            src: url(_next/static/media/Inter-Light.8be0a11c.html);
            font-weight: 300;
            font-display: swap
        }
        ...
        @font-face {
            font-family: Inter, sans-serif;
            src: url(_next/static/media/Inter-Regular.8c0fe73b.html);
            font-weight: 400;
            font-display: swap
        }
        ...
        @font-face {
            font-family: Inter, sans-serif;
            src: url(_next/static/media/Inter-Medium.04937818.html);
            font-weight: 500;
            font-display: swap
        }
        ...
        @font-face {
            font-family: Inter, sans-serif;
            src: url(_next/static/media/Inter-Bold.1e3e4a31.html);
            font-weight: 700;
            font-display: swap
        }
    ...
    <section class="deals-section px-15 pt-0" style="position:relative;padding: 0px 0px 0px 0px; margin: 0px 0px 15px 0px;">
        <div class="title-part" style="display:block !important">
            ...
            <p style="font-size: 16px; text-align: center; padding: 10px">Dễ dàng hơn với các bước đơn giản, quý khách hàng có thể nâng hạn mức tín dụng, liên kết thẻ, huỷ thẻ, chuyển trả góp một cách nhanh chóng và an toàn.</p>
        </div>
        <p style="text-align: center">Vui lòng chọn một dịch vụ mà bạn muốn sử dụng:</p>
    ...
    <div>
        <section style="padding-top: 0" id="app">
            <h3 class="title text-center">Trải nghiệm chỉ có trên TECHCOMBANK</h3>
            <p class="text-center" style="font-size: 15px; margin-bottom: 0">Tự động phê duyệt hạn mức mong muốn.</p>
            <p class="text-center" style="font-size: 15px">Cùng vô số ưu đãi tiện ích đi kèm,...</p>
            <div>
                <p style="font-size: 16px; margin: 10px">
                    <strong>Lợi ích của việc tải App</strong>
                </p>
                <div style="margin-left: 10px">
                    <p style="margin: 10px">
                        <span style="color: red; font-size: 15px">* </span>
                        <span style="font-size: 15px">Thủ tục đơn giản, nhanh chóng</span>
                    </p>
                    <p style="margin: 10px">
                        <span style="color: red; font-size: 15px">* </span>
                        <span style="font-size: 15px">Tự động phê duyệt hạn mức (nâng hạn mức, đăng ký mở thẻ,...)</span>
                    </p>
                    <p style="margin: 10px">
                        <span style="color: red; font-size: 15px">* </span>
                        <span style="font-size: 15px">Ưu đãi 30/4, đăng ký mở thẻ hạn mức 100.000.000<span>đ</span> sẽ được phê duyệt tự động</span>
                    </p>
                    <p style="margin: 10px">
                        <span style="color: red; font-size: 15px">* </span>
                        <span style="font-size: 15px">Vô số phần quà hấp dẫn đang chờ bạn</span>
                    </p>
                </div>
    ...
    <div id="block-id-2" bis_skin_checked="1">
        <section class="sec-home-2 pb-3 group-ef lazy-hidden padding-top: 0">
            <div class="container" bis_skin_checked="1">
                <div class="sec-heading text-center" bis_skin_checked="1">
                    <h3 class="title">Cuộc sống dễ dàng hơn cùng TECHCOMBANK</h2>
                    ...
                    <div class="row center end" bis_skin_checked="1">
                        ...
                        <div class="col-md-5" bis_skin_checked="1">
                            <div class="divtext" bis_skin_checked="1">
                                <h2 class="title ">
                                    <div class="html-parser" bis_skin_checked="1">Dịch vụ ngân hàng số</div>
                                </h2>
                ...
                <div class="box style-2 text-white" bis_skin_checked="1">
                    ...
                    <div class="row center " bis_skin_checked="1">
                        ...
                        <div class="col-md-5" bis_skin_checked="1">
                            <div class="divtext" bis_skin_checked="1">
                                <h2 class="title ">
                                    <div class="html-parser" bis_skin_checked="1">Sản phẩm Thẻ</div>
                                </h2>
                ...
                <div class="box style-3 text-white" bis_skin_checked="1">
                    ...
                    <div class="row center end" bis_skin_checked="1">
                        ...
                        <div class="col-md-5" bis_skin_checked="1">
                            <div class="divtext" bis_skin_checked="1">
                                <h2 class="title ">
                                    <div class="html-parser" bis_skin_checked="1">Tiền gửi Online</div>
                                </h2>
                ...
                <div class="box style-4 text-white" bis_skin_checked="1">
                    ...
                    <div class="row center " bis_skin_checked="1">
                        ...
                        <div class="col-md-5" bis_skin_checked="1">
                            <div class="divtext" bis_skin_checked="1">
                                <h2 class="title ">
                                    <div class="html-parser" bis_skin_checked="1">Gói giải pháp tài chính</div>
                                </h2>
        ...
        <div class="row g-3 offer-corner-section">
            ...
            <div class="contentBody">
                ...
                <div class="download-mobile-button">
                    <a href="/dang-ky-nang-cap" target="_blank">
            ...
            <div class="home-slider-oneOne slick-default theme-dots">
                <div>
                    <div class="card" style="width: 100%;border: none;">
                        ...
                        <div class="card-body" style="text-align: center;background: #e3e3e3;position: relative;overflow: hidden;width: 100%;height: 100%;">
                            <p class="card-text whyChoose__item__title" style="font-size: 17px; line-height: 22px;color: #000000;text-transform:uppercase; margin-bottom: 0; margin-top: 10px">Mr. Nguyễn Trường Phong</p>
                            <p style="text-align: center; padding: 10px">“TECHCOMBANK rất nổi tiếng tại Việt Nam, là một trong những ngân hàng tôi yêu thích nhất. Tôi rất hài lòng về dịch vụ của ngân hàng và rất phù hợp với những người đam mê công nghệ như tôi.”</p>
                        </div>
                    </div>
                </div>
                <!-- <div>
                    <div class="card" style="width: 100%;border: none;">
                        ...
                        <div class="card-body" style="text-align: center;background: #e3e3e3;position: relative;overflow: hidden;width: 100%;height: 100%;">
                            <p class="card-text whyChoose__item__title" style="font-size: 17px;line-height: 22px;color: #000000;text-transform:uppercase; margin-bottom: 0; margin-top: 10px">Ms. Đặng Ngọc Thanh Hà</p>
                            <p style="text-align: center; padding: 10px">“Khi mở tài khoản tại TECHCOMBANK, tôi chỉ cần thao tác ngay trên ứng dụng điện thoại và chụp CCCD để xác minh là xong. Thật may là không cần đến chi nhánh nữa, chỉ mất khoảng 1 phút là có tài khoản dùng rồi.”</p>
                        </div>
                    </div>
                </div> -->
    ...
    margin-bottom: 20px;">
                <div class="row no-gutters">
                    <div class="col-md-12 footer__content__left">
                        <div class="footer__content__left__logo" style="text-align: center;">
                            <a href="/"><img src="UploadImages/Data/Banner/logo.webp" class="img-logo" alt="logo 2021" style="width:50%"></a>
                        </div>
        ...
        <section class="footer__copyright my-5">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 footer__copyright__left">© 2024 TECHCOMBANK – Bản quyền đã được bảo hộ</div>
                </div>
            </div>
    </footer>
